...
# Order fulfillment and cart-resolution live in the service layer:
# apiApp/services/checkout.py -> fulfill_checkout, _resolve_cart_code_from_session.
# (imported at the top of this module via `from .services import ...`)
