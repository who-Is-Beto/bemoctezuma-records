...
urlpatterns = [
    ...
    path('bazares/', views.bazar_list, name='bazar-list'),
    path('bazares/all/', views.admin_list_bazares, name='admin-list-bazares'),
    path('bazares/create/', views.bazar_create, name='bazar-create'),
    path('bazares/<int:bazar_id>/update/', views.admin_update_bazar, name='admin-update-bazar'),
    path('bazares/<int:bazar_id>/delete/', views.admin_delete_bazar, name='admin-delete-bazar'),
